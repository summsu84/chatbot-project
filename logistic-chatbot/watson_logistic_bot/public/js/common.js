...
var Common = (function() {
  ...
  function buildDomElementFromJson(domJson) {
    ...
    //button test - 20171027 - JJW
    if(domJson.tagName == 'button')
    {
      createButtonEvent(element);
    }
  ...
  //20171027 - JJW - 버튼이벤트 처리
  function createButtonEvent(element)
  {
    element.onclick = function() { // Note this is a function
      // alert("value : " + element.value);
      var input = document.getElementById('textInput');
      input.value = element.value;
      // Send the user message (20170426 -JJW 추가)
      var context;
      ...
      Api.sendRequest(input.value, context);
